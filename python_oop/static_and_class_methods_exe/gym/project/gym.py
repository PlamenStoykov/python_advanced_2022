...
class Gym:
    def get_value(self, value_id, value_list):
        searched_val = None
    ...
    def subscription_info(self, subscription_id: int):
        searched_sub = self.get_value(subscription_id, self.subscriptions)
        searched_customer = self.get_value(subscription_id, self.customers)
        searched_trainer = self.get_value(subscription_id, self.trainers)
        searched_equipment = self.get_value(subscription_id, self.equipment)
        searched_plan = self.get_value(subscription_id, self.plans)
        result = repr(searched_sub) + '\n'
        result += repr(searched_customer) + '\n'
        result += repr(searched_trainer) + '\n'
        result += repr(searched_equipment) + '\n'
        result += repr(searched_plan) + '\n'
        return result
